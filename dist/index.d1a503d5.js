...
(function() {
    ...
    */ const _modeAdjust = function(a, b, c, d, mode) {
        if (mode === p5.prototype.CORNER) return {
            x: a,
            y: b,
            w: c,
            h: d
        };
        else if (mode === p5.prototype.CORNERS) return {
            x: a,
            y: b,
            w: c - a,
            h: d - b
        };
        else if (mode === p5.prototype.RADIUS) return {
            x: a - c,
            y: b - d,
            w: 2 * c,
            h: 2 * d
        };
        else if (mode === p5.prototype.CENTER) return {
            x: a - c * 0.5,
            y: b - d * 0.5,
            w: c,
            h: d
    ...
    */ const _disableColor = function(_renderTarget) {
    ...
    p5.prototype.rectPattern = function(...args) {
        ...
        const val = _modeAdjust(arguments[0], arguments[1], arguments[2], arguments[3], this._renderer._rectMode);
    ...
    p5.prototype.squarePattern = function(...args) {
        ...
        const val = _modeAdjust(arguments[0], arguments[1], arguments[2], arguments[2], this._renderer._rectMode);
        this._patternControler.applyPattern(val.x, val.y, val.w, val.h, this);
        return r;
    };
    //ellipse
    p5.prototype.ellipsePattern = function(...args) {
        ...
        const val = _modeAdjust(arguments[0], arguments[1], arguments[2], arguments[3], this._renderer._ellipseMode);
        this._patternControler.applyPattern(val.x, val.y, val.w, val.h, this);
        return r;
    };
    //arc
    ...
    p5.prototype.circlePattern = function(...args) {
        ...
        const val = _modeAdjust(arguments[0], arguments[1], arguments[2], arguments[2], this._renderer._ellipseMode);
        this._patternControler.applyPattern(val.x, val.y, val.w, val.h, this);
        return r;
    };
    //triangle
    ...
    p5.prototype.bezierVertexPattern = function(...args) {
        ...
        this._patternVertexInfo.addBezierVertex(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
        return r;
    };
    p5.prototype.quadraticVertexPattern = function(...args) {
        const r = this.quadraticVertex(...args);
        this._patternVertexInfo.addQuadraticVertex(arguments[0], arguments[1], arguments[2], arguments[3]);
        return r;
    };
...
const PTN = {
    ...
    */ _customTiling: function(_spaceX, _spaceY, _tileFunc, _useOffset = false) {
     ...
     */ dot: function(_space = 15, _dia = 7) {
        const func = PTN._customTiling(_space, _space, function(_rt) {
            _rt.noStroke();
            _rt.ellipseMode(_rt.CENTER);
            _rt.circle(0, 0, _dia);
        }, false);
     ...
     */ checked: function(...args) {
        ...
        const func = PTN._customTiling(w * 2, h, function(_rt) {
            _rt.noStroke();
            _rt.rectMode(_rt.CORNER);
            _rt.rect(0, 0, w, h);
        }, true);
     ...
     */ triangle: function(_triW = 20, _triH = 20) {
        const func = PTN._customTiling(_triW, _triH, function(_rt) {
            _rt.noStroke();
...
//# sourceMappingURL=index.d1a503d5.js.map
